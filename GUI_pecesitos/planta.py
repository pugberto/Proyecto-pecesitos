...
class Ventana_insertar_planta(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def initUI4(self):
        ...
        self.setWindowTitle('insertar_planta')
        ...
        label_funcion = QLabel('función:', self)
    ...
    def procesar_datos2(self):
        ...
        t_func = self.line_edit_funcion.text()
        ...
        val = (id, tanque, t_habitad, t_alimento, "Planta")
