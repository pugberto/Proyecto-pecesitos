...
class Ventana_update_plantas(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI9()
    ...
    def initUI9(self):
        ...
        label_funcion = QLabel('Funcion:', self)
        self.line_edit_funcion = QLineEdit(self)
        ...
        layout.addWidget(self.line_edit_funcion)
    ...
    def procesar_datos2(self):
        ...
        t_funcion = self.line_edit_funcion.text()
        ...
        if t_funcion:
            self.datos.append(("Funcion", t_funcion))
        ...
        if id:
            for elemt in self.datos:
                if elemt[0] == "Funcion":
                    sql_update = "UPDATE planta SET Funcion = %s WHERE ID_planta = %s"
